  ...
  class Paso2DatosDelLocalOEmpresa < TemplateCode::Step
    ...
    form_data.set("solicitante_natural.datos_del_local.se_dedicara_a_ofrecer","Contrato de arrendamiento financiero de bienes muebles.")
else
     form_data.set("solicitante_juridico.datos_generales_de_empresa.se_dedicara_a_ofrecer_texto","Contrato de arrendamiento financiero de bienes muebles.")
end
    end
