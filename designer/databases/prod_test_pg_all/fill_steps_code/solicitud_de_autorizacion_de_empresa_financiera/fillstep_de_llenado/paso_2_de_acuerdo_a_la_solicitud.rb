  ...
  class Paso2DeAcuerdoALaSolicitud < TemplateCode::Step

    on_becoming do
      ### Agregado 15/-2/2017 MT
if @owner["kind_of_user_type"] == "NaturalPerson"
   form_data.set("solicitante_natural.datos_del_abogado_litigante.lo_que_se_desea_operar","Empresa Financiera")
   form_data.set("solicitante_natural.datos_del_abogado_litigante.ley_correspondiente","Ley 42 del 23 de Julio de 2001.")
else
  form_data.set("solicitante_juridico.de_acuerdo_a_la_solicitud.lo_que_se_desea_operar","Empresa Financiera")
  form_data.set("solicitante_juridico.de_acuerdo_a_la_solicitud.ley_correspondiente","Ley 42 del 23 de Julio de 2001.")
end
    end
...
if @owner["kind_of_user_type"] == "JuridicalPerson"
  ...
  if emp.nil?
      ...
      form_data.set("solicitante_juridico.datos_generales_de_empresa.ruc",emp["ruc"])
      #form_data.set("solicitante_juridico.datos_generales_de_empresa.tipo_sociedad",emp["tipo_sociedad"])
