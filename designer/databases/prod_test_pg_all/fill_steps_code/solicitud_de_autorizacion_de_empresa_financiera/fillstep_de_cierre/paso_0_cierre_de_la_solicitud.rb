  ...
  class Paso0CierreDeLaSolicitud < TemplateCode::Step
...
// Chantal Valverde. 6-Abr-2017. Etiquetas y Hints de adjuntos
// Chantal Valverde 6-Abr-2017
$( function() {
  $(".hint").each (function(){
...
// Hasta aquí etiquetas y hints de adjuntos
