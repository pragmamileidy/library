...
_datoRequest =  form_data.get("variables_usadas_codigos_p5.variables_p5.request")
...
if ((status == "started") || (status == "error") || (status == "created"))
  ...
  _resultMakeP = PaymentProxy.make_payment(hash)
	...
	if !_error.nil?
		...
		form_data.set("variables_usadas_codigos_p5.variables_p5.request", _datoReq)
		form_data.set("mensajes_pago.mensaje_pendiente.texto_1", _strurl)
		form_data.set("mensajes_pago.mensaje_pendiente.texto_2",@task["id"])
		form_data.set("mensajes_pago.mensaje_fallido.texto_1", _strurl)
...
#CODIGO PARA INVOCAR get_payment_status
_paymentId = form_data.get("variables_usadas_codigos_p5.variables_p5.payment")
_dato2 =  form_data.get("variables_usadas_codigos_p5.variables_p5.request")
