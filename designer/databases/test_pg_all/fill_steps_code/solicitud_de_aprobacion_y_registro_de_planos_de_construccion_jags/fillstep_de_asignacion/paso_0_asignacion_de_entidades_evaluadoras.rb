  ...
  class Paso0AsignacionDeEntidadesEvaluadoras < TemplateCode::Step
...
form_data.set("seccion_de_funcionario_jefe1.datos_del_funcionario_generico.usuario", _agente["name"])
    end
...
_obs = form_data.get("seccion_de_funcionario_jefe1.datos_del_funcionario_generico.observaciones")
_eval = form_data.get("seccion_de_funcionario_jefe1.datos_del_funcionario_generico.evaluacion")
...
$("#field_datos_generales_del_proyecto_datos_generales_del_proyecto_nro_oculto").parent().parent().hide();
  ...
  dato= $("#field_datos_generales_del_proyecto_datos_generales_del_proyecto_uso_de_la_obra");
    if($(dato).html() != 'Otros'){
